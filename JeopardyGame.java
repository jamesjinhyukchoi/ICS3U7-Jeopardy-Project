...
public class JeopardyGame
{
     ...
     * 
     * @param fileName the category file of this game
     */
    public JeopardyGame()
    {
        
        // Get the static value of count of category from Welcome class
        ...
        categoryData = new CategoryGameData();
    ...
    private void makeMainButtonPanel()
    {
        ...
        mainButtonPanel.setLayout(new GridLayout(questionCount + 1, categoryCount));
        ...
        questionButton = new JButton[categoryCount][questionCount];
    ...
    private void makeQuestionPanel(int categoryNumber, int questionNumber)
    {
        ...
        answerButton = new JButton[categoryCount][ANSWER_COUNT];
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            for (int answerNumber = 0; answerNumber < ANSWER_COUNT; answerNumber++)
            {
                if (source == answerButton[currentQuestionNumber][answerNumber])
                {
                    ...
                    if (questionsCompleted == categoryCount * ANSWER_COUNT)
                    {
                        mainButtonPanel.setVisible(false);
